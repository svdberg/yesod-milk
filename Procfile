...
#     echo '{ "name": "milkmachine", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/milkmachine/milkmachine
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/milkmachine/milkmachine production -p $PORT
